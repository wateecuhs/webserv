...
Request::Request(): _method(GET), _pathIsDirectory(false), _http_version(1.1), _hasCookies(false) {}

Request::Request(std::string request): _method(GET), _pathIsDirectory(false), _http_version(1.1), _hasCookies(false)
{
...
Request::Request(Request &src): _method(GET), _pathIsDirectory(false), _http_version(1.1), _hasCookies(false)
{
	*this = src;
}
